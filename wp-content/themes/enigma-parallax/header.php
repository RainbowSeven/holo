...
<div>
	...
	<a href="#slider" class="btn " data-toggle="tooltip" title="Slider"><i class="fa fa-caret-square-o-right"></i></a><br />
	<?php } ?>
	<?php if($wl_theme_options['service_home'] == "1") { ?>
	<a href="#service" class="btn " data-toggle="tooltip" title="Service"><i class="fa fa-yelp"></i></a><br />
	<?php } ?>
	<?php if($wl_theme_options['portfolio_home'] == "1") { ?>
	<a href="#portfolio" class="btn " data-toggle="tooltip" title="Portfolio"><i class="fa fa-picture-o"></i></a><br />
	<?php } ?>
	<?php if($wl_theme_options['show_testimonial'] == "1") { ?>
	<a href="#testimonial" class="btn " data-toggle="tooltip" title="Testimonial"><i class="fa fa-desktop"></i></a><br />
	<?php } ?>
	<?php if($wl_theme_options['show_blog'] == "1") { ?>
	<a href="#blog" class="btn" data-toggle="tooltip" title="Blog"><i class="fa fa-book"></i></a><br />
	<?php } ?>
	<?php if($wl_theme_options['show_team'] == "1") { ?>
	<a href="#team" class="btn " data-toggle="tooltip" title="Team"><i class="fa fa-users"></i></a><br />
	<?php } ?>
	<?php if($wl_theme_options['show_contact'] == "1") { ?>
	<a href="#contact" class="btn " data-toggle="tooltip" title="Contact"><i class="fa fa-phone"></i></a>
	<?php } ?>
	</div>
