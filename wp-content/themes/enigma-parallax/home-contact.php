			...
			<div class="enigma_contact_form_fields">
				<div id="weblizar_form"> 
					<form role="form" method="POST"  action="#">	
						<div class="enigma_contact_group scrollimation scale-in">
						...
						<div class="enigma_form_textarea scrollimation scale-in">
						...
						<button class="enigma_send_button scrollimation scale-in" type="submit" name="query_submit" id="query_submit">Send Message</button>
					</form>
				</div>
